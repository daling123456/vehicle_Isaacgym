...
class TMBoxTerrain(Terrain):
    ...
    def prepare(self):
        ...
        self.terrain_cell_bounds = {
            "x_min": torch.zeros(self.env.cfg.terrain.num_rows, self.env.cfg.env.terrain.num_cols, device=self.env.device),
            "y_min": torch.zeros(self.env.cfg.terrain.num_rows, self.env.cfg.env.terrain.num_cols, device=self.env.device),
            "x_max": torch.zeros(self.env.cfg.terrain.num_rows, self.env.cfg.env.terrain.num_cols, device=self.env.device),
            "y_max": torch.zeros(self.env.cfg.terrain.num_rows, self.env.cfg.env.terrain.num_cols, device=self.env.device)
        }
